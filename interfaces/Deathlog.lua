...
function Sauercrowd:UpdateMiniDeathLog()
    ...
    for i = 1, maxRows do
        ...
        if entry and rowFrame:IsShown() then
            ...
            local safeCause = Sauercrowd:SanitizeText(entry.cause)
            ...
            rowFrame:SetScript("OnEnter", function()
                ...
                if safeCause and safeCause ~= "" then
                    GameTooltip:AddDoubleLine("Gestorben durch:", safeCause, 0.8, 0.8, 0.8, 1, 0.2, 0.2)
                end
